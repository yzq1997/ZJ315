...
(function getdata() {
    ...
    $.ajax({
        url: `http://www.zjxf315.com:8080/api/DTcmsAPI.ashx?dotype=GetArticleDetailNew&channel_id=2223&category_id=5470&rows=${row}&strOrder=sort_id%2Cadd_time+desc&articleType=&article_id=${id}&strWhere=multiple_single_selection+in+(0,1)`,
        type: 'get',
        dataType: "jsonp",
        jsonp: "callback",
        ...
        success: function (res) {
            ...
            // document.getElementsByClassName("p1")[0].innerHTML = res.currentArticleList[0].title
            // document.getElementsByClassName("p2")[0].innerHTML = y+'-'+m+'-'+d+"     " + h+':'+minute 
            // document.getElementsByClassName("p3")[0].innerHTML = res.currentArticleList[0].content 
        }
    })
})();
